...
public class PurpleFood extends GameObject {
	

	private Texture tex = Game.getInstance();
	
	public PurpleFood(float x, float y, Handler handler, ObjectId id) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		...
		g.drawImage(tex.PurpleFood[0], (int) x, (int) y, 32 , 32 ,null);
