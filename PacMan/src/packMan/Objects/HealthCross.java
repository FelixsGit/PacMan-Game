...
public class HealthCross extends GameObject {
	


	private Texture tex = Game.getInstance();
	
	public HealthCross(float x, float y, Handler handler, ObjectId id) {
		super(x, y, id);
	...
	public void render(Graphics g) {
		...
		g.drawImage(tex.HealthCross[0], (int) x, (int) y, 32 , 32 ,null);
		/*
